        ...
        var o = a(5),
            ...
            s = function () {
                function e(t) {
                    ...
                    var m = {
                            "Message is loading": "留言加載中",
                            Top: "頂部",
                            Bottom: "底部",
                            Rolling: "滾動",
                            "Input message, hit Enter": "輸入留言",
                            "About author": "關於作者",
                            "DPlayer feedback": "播放器意見反饋",
                            "About DPlayer": "關於 DPlay 播放器",
                            Loop: "循環",
                            Speed: "速度",
                            "Opacity for message": "留言透明度",
                            Normal: "正常",
                            "Please input message!": "請輸入內容",
                            "Set message color": "設置留言顏色",
                            "Set message type": "設置留言類型",
                            Danmaku: "留言"
                        },
                        c = function (e) {
                    ...
                    this.setTime = function () {
                        ...
                        a.option.danmaku && (T = setInterval(function () {
            ...
            a.onreadystatechange = function () {
                if (4 === a.readyState)
                    if (a.status >= 200 && a.status < 300 || 304 === a.status) {
                        ...
                        1 !== e.code ? console.log(e.msg) : console.log("Post danmaku: ", JSON.parse(a.responseText))
